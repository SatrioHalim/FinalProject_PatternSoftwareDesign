<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="FinalProject_PatternSoftwareDesign.View.Register" %>
    ...
    <form id="form1" runat="server">
        <div class="register-container">
            ...
            <div class="login-link">
                <a href="../Login/Login.aspx">Login here</a>
            </div>
        </div>
    </form>
</body>
